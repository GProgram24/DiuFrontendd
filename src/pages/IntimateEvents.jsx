...
const IntimateEvents = () => {
    ...
    return (
        <div className='w-full min-h-[80vh] pt-[70px] md:pt-[80px] flex flex-col '>
            <div className='w-full aspect-video lg:h-[70vh] bg-center bg-cover' style={{ backgroundImage: `url("/Banners/Intimate Celebrations1.png")` }}>
            </div>
            ...
            <div className='w-full px-5 lg:px-[100px] xl:px-[150px] flex flex-col items-center '>
                ...
                <div className='w-full  flex flex-col-reverse  items-center lg:flex-row justify-between gap-5 lg:gap-[40px] xl:gap-[71px] md:my-8'>
                    <div className='lg:w-[700px] lg:h-[300px] xl:w-[665px] flex flex-col items-start justify-center gap-3 '>
                        ...
                        <p className='text-[14px] xl:text-base font-subHeading leading-[22px] md:leading-[26px]'>At Do It Up, personalized intimate celebration decor is our claim to fame. As top-rated decor services providers in India, we've mastered the art of creating unforgettable experiences in small settings. During times when large gatherings were restricted, we pioneered custom decor for home-based celebrations. Our unique service allows people to commemorate special moments within the comfort and safety of their homes. From birthdays and anniversaries to bridal showers and baby's first milestones, we've transformed everyday spaces into magical venues. Whether it's a romantic date night or a cozy family celebration, Do It Up is committed to making every intimate event extraordinary.</p>
                    </div>
