                ...
                <div className='w-full min-h-[80vh] flex flex-col items-center pb-14'>
                    ...
                    <div className='w-full grid grid-cols-2 lg:grid-cols-3 gap-[6px] md:gap-5 place-items-center '>
                        ...
                        <div className='w-full flex flex-col gap-[6px] md:gap-5 '>
                            ...
                            <div className="w-full h-[188px] md:h-[400px] xl:h-[477px] bg-center bg-cover" style={{ backgroundImage: `url("/Services (Rename Later)/Brand Installations/Featured/Gallops tea party/Copy of 146A5526.jpg")` }}>
                                <div className="opacity-0 hover:opacity-100 hover:bg-gradient-to-t from-black/40  w-full h-full font-subHeading text-white flex flex-col items-start justify-end pl-3 md:pl-6 pb-3 md:pb-5 transition-opacity duration-300 ease-in-out">
                                    <h1 className="text-base leading-tight">Name of the Event</h1>
                                    <p className="text-sm font-light">Location</p>
                                </div>
                        ...
                        <div className='w-full flex flex-col gap-[6px] md:gap-5 '>
                            ...
                            <div className="w-full h-[128px] md:h-[220px] xl:h-[300px] bg-center bg-cover" style={{ backgroundImage: `url("/Services (Rename Later)/Brand Installations/Featured/Gallops tea party/Copy of 146A5526.jpg")` }}>
                                <div className="opacity-0 hover:opacity-100 hover:bg-gradient-to-t from-black/40  w-full h-full font-subHeading text-white flex flex-col items-start justify-end pl-3 md:pl-6 pb-3 md:pb-5 transition-opacity duration-300 ease-in-out">
                                    <h1 className="text-base leading-tight">Name of the Event</h1>
                                    <p className="text-sm font-light">Location</p>
                                </div>
                            ...
                            <div className="w-full h-[188px] md:h-[400px] xl:h-[477px] bg-center bg-cover" style={{ backgroundImage: `url("/Services (Rename Later)/Brand Installations/Featured/Gallops tea party/Copy of 146A5471.jpg")` }}>
                                <div className="opacity-0 hover:opacity-100 hover:bg-gradient-to-t from-black/40  w-full h-full font-subHeading text-white flex flex-col items-start justify-end pl-3 md:pl-6 pb-3 md:pb-5 transition-opacity duration-300 ease-in-out">
                                    <h1 className="text-base leading-tight">Name of the Event</h1>
                                    <p className="text-sm font-light">Location</p>
                                </div>
                        ...
                        <div className='w-full lg:flex flex-col gap-5 hidden '>
                            <div className="w-full md:h-[220px] xl:h-[300px] bg-center bg-cover" style={{ backgroundImage: `url("/Services (Rename Later)/Brand Installations/Featured/Gallops tea party/Copy of 146A5373.jpg")` }}>
                            ...
                            <div className="w-full md:h-[400px] xl:h-[477px] bg-center bg-cover" style={{ backgroundImage: `url("/Services (Rename Later)/Brand Installations/Featured/Gallops tea party/Copy of 146A5471.jpg")` }}>
                                <div className="opacity-0 hover:opacity-100 hover:bg-gradient-to-t from-black/40  w-full h-full font-subHeading text-white flex flex-col items-start justify-end pl-6 pb-5 transition-opacity duration-300 ease-in-out">
                                    <h1 className="text-base leading-tight">Name of the Event</h1>
                                    <p className="text-sm font-light">Location</p>
                                </div>
                            ...
                            <div className="w-full md:h-[220px] xl:h-[300px] bg-center bg-cover" style={{ backgroundImage: `url("/Services (Rename Later)/Brand Installations/Featured/Gallops tea party/Copy of 146A5526.jpg")` }}>
                                <div className="opacity-0 hover:opacity-100 hover:bg-gradient-to-t from-black/40  w-full h-full font-subHeading text-white flex flex-col items-start justify-end pl-6 pb-5 transition-opacity duration-300 ease-in-out">
                                    <h1 className="text-base leading-tight">Name of the Event</h1>
                                    <p className="text-sm font-light">Location</p>
                                </div>
                            ...
                            <div className="w-full md:h-[400px] xl:h-[477px] bg-center bg-cover" style={{ backgroundImage: `url("/Services (Rename Later)/Brand Installations/Featured/Gallops tea party/Copy of 146A5539.jpg")` }}>
                                <div className="opacity-0 hover:opacity-100 hover:bg-gradient-to-t from-black/40  w-full h-full font-subHeading text-white flex flex-col items-start justify-end pl-6 pb-5 transition-opacity duration-300 ease-in-out">
                                    <h1 className="text-base leading-tight">Name of the Event</h1>
                                    <p className="text-sm font-light">Location</p>
                                </div>
