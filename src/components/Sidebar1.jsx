                ...
                <div className='bg-white h-full'>
                    <div className='w-full h-[70px] md:h-[80px] px-5 '>
                        <div className='w-full h-full flex justify-between items-center '>
                            <div className='text-base font-semibold text-white'>
                                <NavLink to='/'><img src='/Logo.png' alt="Logo" onClick={toggleSidebar}></img></NavLink>
                            </div>
                            <button className=''>
                    ...
                    <div className='w-full h-full bg-black'>
                        <div className='w-full h-full flex flex-col px-5  pt-10   text-white'>
                            ...
                            <Link to='/contact'><button  onClick={toggleSidebar} className='px-5 md:px-7 py-2 w-[175px] h-[42px] border border-white hover:bg-white text-base hover:text-black rounded-xl'>CONTACT US</button></Link>
                        </div>
                    </div>
                </div>
            </div>
